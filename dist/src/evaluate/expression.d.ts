...
export declare function LogicalExpression(node: ESTree.LogicalExpression, scope: Scope): Generator<any, unknown, any>;
...
export declare function ConditionalExpression(node: ESTree.ConditionalExpression, scope: Scope): Generator<any, unknown, any>;
...
export declare function SpreadElement(node: ESTree.SpreadElement, scope: Scope): Generator<any, unknown, any>;
