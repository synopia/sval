...
export declare function LogicalExpression(node: ESTree.LogicalExpression, scope: Scope): unknown;
...
export declare function ConditionalExpression(node: ESTree.ConditionalExpression, scope: Scope): unknown;
...
export declare function SpreadElement(node: ESTree.SpreadElement, scope: Scope): unknown;
